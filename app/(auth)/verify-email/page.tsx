      ...
      <div className="min-h-screen bg-gradient-to-b from-sand-50 to-cream flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl font-display font-bold text-forest-800">Email Verification</h1>
          ...
          <div className="space-y-4">
            ...
            {resendMessage && (
              <p className="text-sm text-center text-forest-600 font-body">{resendMessage}</p>
            )}
          </div>

          <div className="mt-6 text-center">
            <Link href="/login" className="text-sm text-forest-600 hover:text-forest-800 font-body">
              Back to Login
            </Link>
          </div>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-sand-50 to-cream flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <h1 className="text-2xl font-display font-bold text-forest-800">Verifying Your Email</h1>
          <p className="text-forest-600 mt-2 font-body">
    ...
    <div className="min-h-screen bg-gradient-to-b from-sand-50 to-cream flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-display font-bold text-forest-800">Verification Failed</h1>
          <p className="text-earth-600 mt-2 font-body">{message}</p>
        </div>
...
function LoadingFallback() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-sand-50 to-cream flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        <Loader2 className="w-12 h-12 text-forest-600 animate-spin mx-auto mb-4" />
        <h1 className="text-2xl font-display font-bold text-forest-800">Loading...</h1>
      </div>
    </div>
  )
}
