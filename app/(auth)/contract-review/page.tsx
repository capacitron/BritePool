...
export default function ContractReviewPage() {
  ...
  const handleScroll = useCallback(() => {
    ...
    const progress =
      scrollableHeight > 0 ? Math.min((scrollTop / scrollableHeight) * 100, 100) : 100
  ...
  async function handleAccept() {
    ...
    try {
      ...
      await updateSession()
      const updatedSession = await fetch('/api/auth/session', { credentials: 'include' }).then(
        (res) => res.json()
      )
        ...
        <div className="max-w-prose mx-auto px-4 md:px-6 py-4 md:py-6">
          ...
          >
            ...
            >
              ...
              <strong className="text-forest-800">Membership Agreement</strong> and understand my
              rights and obligations as a BRITE POOL member.
            </span>
          </label>
