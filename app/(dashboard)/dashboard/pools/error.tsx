...
import { AlertTriangle, RefreshCw, ArrowLeft, DollarSign } from 'lucide-react'
      ...
      <div className="text-center max-w-md">
        <div className="mx-auto h-20 w-20 rounded-full bg-earth-500/10 flex items-center justify-center">
          <div className="relative">
            <DollarSign className="h-10 w-10 text-earth-500" />
        ...
        <p className="mt-3 text-forest-600">
          We could not load the investment pools at this time. This might be due to a connection
