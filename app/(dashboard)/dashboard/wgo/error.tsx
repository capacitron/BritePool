...
export default function WGOError({
  error,
  reset,
}: {
      ...
      <div className="text-center max-w-md">
        <div className="mx-auto h-20 w-20 rounded-full bg-earth-500/10 flex items-center justify-center">
          <div className="relative">
            <TrendingUp className="h-10 w-10 text-earth-500" />
        ...
        <p className="mt-3 text-forest-600">
          We could not load the Wealth-Generating Opportunities at this time. Please refresh the
