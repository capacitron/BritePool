...
function calculateColorTotals(pool: PoolWithAggregates): ColorTotals {
  ...
  for (const cut of pool.cuts) {
    ...
    const confirmedPledges = cut.pledges.filter(
  ...
  totals.blue.pledgeCount =
    totals.purple.pledgeCount + totals.orange.pledgeCount + totals.green.pledgeCount
...
export default async function TransparencyPage() {
  ...
  const poolProgress =
    pool && pool.targetAmount > 0 ? (pool.currentAmount / pool.targetAmount) * 100 : 0
  const isGoalReached = pool ? pool.status === 'COMPLETED' || poolProgress >= 100 : false

  // Calculate overall progress
  const overallProgress =
    budgetGoal > 0 ? Math.round((totalFromAllPools / budgetGoal) * 100 * 10) / 10 : 0
  ...
  return (
    <LockedPageGuard feature="Transparency Hub">
      <div className="space-y-8">
        <div>
          <h1 className="text-3xl font-display font-bold text-forest-800">Transparency Hub</h1>
        ...
        {hasPool && pool ? (
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="font-display text-forest-800">{pool.name}</CardTitle>
                  ...
                  {colorTotals && pool.targetAmount > 0 && (
                    <>
                      <div
                        ...
                        style={{
                          width: `${(colorTotals.purple.total / pool.targetAmount) * 100}%`,
                        }}
                      />
                      <div
                        className="h-full bg-orange-500"
                        style={{
                          width: `${(colorTotals.orange.total / pool.targetAmount) * 100}%`,
                        }}
                      />
                      <div
          ...
          <Card className="border-sand-200 bg-sand-50">
            <CardContent className="py-8 text-center">
              ...
              <p className="text-forest-600 font-body">No active stakeholder pool at this time</p>
            </CardContent>
          </Card>
        )}
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold font-display text-forest-800">
                    {totalFromAllPools > 0 ? `$${totalFromAllPools.toLocaleString()}` : '$0'}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold font-display text-forest-800">
                    {budgetGoal > 0 ? `$${budgetGoal.toLocaleString()}` : '$0'}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              {financialReports.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-forest-500 font-body">No financial reports available yet</p>
              ...
              <Link href="/dashboard/documents?category=FINANCIAL">
                <Button
                  variant="outline"
                  className="w-full mt-4 border-forest-600 text-forest-700 hover:bg-forest-50"
                >
          ...
          <Card className="hover:shadow-lg transition-shadow border-sand-200">
            ...
            <CardContent>
              <Link href="/dashboard/documents?category=FINANCIAL">
                <Button
                  variant="outline"
                  className="w-full border-forest-600 text-forest-700 hover:bg-forest-50"
                >
                  View Audit Reports
