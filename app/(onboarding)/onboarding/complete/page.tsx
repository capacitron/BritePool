    ...
    <div className="space-y-8">
      <Card className="border-earth-brown-light/20 shadow-lg text-center">
        ...
        <CardContent>
          <p className="text-lg text-earth-brown mb-6">
            Welcome to the BRITE POOL community! Your profile is set up and you&apos;re ready to start your journey.
          </p>
      ...
      <div className="flex justify-center">
        <Button
          ...
          disabled={isLoading}
          size="lg"
          className="bg-earth-gold hover:bg-earth-gold-dark text-white px-12 py-4 text-lg"
        >
