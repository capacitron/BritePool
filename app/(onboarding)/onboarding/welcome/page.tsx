    ...
    <div className="space-y-8">
          ...
          <CardContent className="pt-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm text-earth-brown-light">
                Participate in governance, wealth building, education, health, and operations
                initiatives.
              </p>
            </div>
          </CardContent>
      ...
      <div className="flex justify-end">
        <Button
          onClick={handleNext}
          disabled={isLoading}
          className="bg-earth-brown-dark hover:bg-earth-brown text-white px-8 py-3 text-lg font-semibold shadow-lg"
        >
