...
export async function GET(
  ...
  try {
    ...
    logError(error, { action: 'fetch_map_location' })
    return NextResponse.json({ error: 'Failed to fetch map location' }, { status: 500 })
  }
}
...
export async function PATCH(
  ...
  try {
    ...
    logError(error, { action: 'update_map_location' })
    ...
    return NextResponse.json({ error: 'Failed to update map location' }, { status: 500 })
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    logError(error, { action: 'delete_map_location' })
    return NextResponse.json({ error: 'Failed to delete map location' }, { status: 500 })
  }
}
